...
I think the portfolio project allowed me to better understand how to implement my own component and gave me a deeper understanding of each part of the project such as interfaces, abstract classes, and implementations. I was able to figure out how each part worked as I went throug the project.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

Throughout the portfolio porject I felt I didn't understand how to code some parts but I was able to figure them out as I continued through the project and gained more understading of other parts.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

I still enjoy software development. I enjoyed learning how to create my own component in java and learning the parts that go into it.
...
Through the process of creating the portfolio project I learned skills in terms of creating interfaces, creating abstract classes, brainstorming ideas, and identifying issues in code. I was able to see where I needed to add methods or change parts of methods as I worked on the project. I also learned how to create a project piece by piece and adjust it as more parts are created.
...
I think the project hasn't affected my career trajectory a lot because I haven't decided what I want to do specifically yet, but I enjoyed making the project.
...
I have learned how to create my own code/component in java so I will be able to do something similar in the future and I can learn how to do more things outside of the OSU structure for coding.
