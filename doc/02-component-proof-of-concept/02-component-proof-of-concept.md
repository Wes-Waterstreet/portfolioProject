...
The design I will be implementing is the media rating tracker. This component should be achievable in the time frame for the project and it can be used to track shows and movies wathched.
